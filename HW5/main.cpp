...
void StudentTests() {
  ...
  std::cout << "STUDENT TESTS" << std::endl;
    ...
    //----------------------------------------------------------------------------------//
    //making sure you can pushback a popfront
    std::cout << std::endl << "Testing moving cars from one train to another" << std::endl;
    std::cout << "This will test the function PopFront" << std::endl;
    // create a train with 6 dynamically-allocated cars in a doubly-linked list structure
    TrainCar* simple1 = NULL;
    PushBack(simple1, TrainCar::MakeEngine());
    PushBack(simple1, TrainCar::MakePassengerCar());
    PushBack(simple1, TrainCar::MakePassengerCar());
    PushBack(simple1, TrainCar::MakeDiningCar());
    PushBack(simple1, TrainCar::MakePassengerCar());
    PushBack(simple1, TrainCar::MakeSleepingCar());
    // helper routine sanity check & print the results
    SanityCheck(simple1);
    PrintTrain(simple1);
    TrainCar* simple2 = NULL;
    std::cout << "Moving front car to other train" << std::endl;
    PushBack(simple2, PopFront(simple1));
    std::cout << "Original Train:" << std::endl;
    SanityCheck(simple1);
    PrintTrain(simple1);
    ...
    SanityCheck(simple2);
    PrintTrain(simple2);
    std::cout << "TESTING PUSHFRONT AND POPFRONT ON EMPTY TRAIN" << std::endl;
    PushBack(simple2, PopFront(simple1));
    std::cout << "Original Train:" << std::endl;
    SanityCheck(simple1);
    PrintTrain(simple1);
    ...
    DeleteAllCars(simple1);
    DeleteAllCars(simple2);
    //----------------------------------------------------------------------------------//

    //testing Separate
    std::cout << std::endl << "Testing Separate" << std::endl;
    TrainCar* simple3 = NULL;
    TrainCar* simple4 = NULL;
    TrainCar* simple5 = NULL;
    PushBack(simple3, TrainCar::MakeEngine());
    PushBack(simple3, TrainCar::MakeFreightCar(50));
    PushBack(simple3, TrainCar::MakeFreightCar(75));
    PushBack(simple3, TrainCar::MakeFreightCar(80));
    PushBack(simple3, TrainCar::MakeEngine());
    PushBack(simple3, TrainCar::MakeFreightCar(100));
    // helper routine sanity check & print the results
    SanityCheck(simple3);
    PrintTrain(simple3);
    Separate(simple3, simple4, simple5);
    SanityCheck(simple3);
    PrintTrain(simple3);
    SanityCheck(simple4);
    PrintTrain(simple4);
    ...
    DeleteAllCars(simple4);
    DeleteAllCars(simple5);

    //testing Separate
    std::cout << std::endl << "Testing Separate" << std::endl;
    PushBack(simple3, TrainCar::MakeEngine());
    PushBack(simple3, TrainCar::MakeFreightCar(60));
    PushBack(simple3, TrainCar::MakePassengerCar());
    PushBack(simple3, TrainCar::MakeEngine());
    PushBack(simple3, TrainCar::MakeFreightCar(50));
    PushBack(simple3, TrainCar::MakeFreightCar(75));
    PushBack(simple3, TrainCar::MakePassengerCar());
    PushBack(simple3, TrainCar::MakeFreightCar(200));
